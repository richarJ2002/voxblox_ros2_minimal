...
class TsdfServer
{
  ...
  protected:
    ...
    /// If the system should subscribe to a pointcloud giving points in
    /// freespace
    ...
    /**
     * Whether to enable ICP corrections. Every pointcloud coming in will
     * attempt to be matched up to the existing structure using ICP. Requires
     * the initial guess from odometry to already be very good.
     */
    bool enable_icp_;
    ...
    /**
     * Queue of incoming pointclouds, in case the transforms can't be
