...
inline TsdfIntegratorBase::Config
    getTsdfIntegratorConfigFromRosParam(rclcpp::Node *node_ptr)
{
    ...
    {
        node_ptr->declare_parameter("allow_clear",
...
inline EsdfIntegrator::Config
    getEsdfIntegratorConfigFromRosParam(rclcpp::Node *node_ptr)
{
    ...
    node_ptr->get_parameter("esdf_default_distance_m",
                            esdf_integrator_config.default_distance_m);
    node_ptr->get_parameter("esdf_min_diff_m",
                            esdf_integrator_config.min_diff_m);
...
inline MeshIntegratorConfig
    getMeshIntegratorConfigFromRosParam(rclcpp::Node *node_ptr)
{
    ...
    node_ptr->get_parameter("mesh_min_weight",
                            mesh_integrator_config.min_weight);
